...
public class ImageAvatar extends JComponent{
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (img != null) {
            ...
            Rectangle size = getAutoSize(img, diameter);
            ...
            g2_img.drawImage(toImage(this.img), size.x, size.y, size.width, size.height, null);
    ...
    private  Rectangle getAutoSize(Icon img, int size) {
        int w = size ;
        int h = size;
