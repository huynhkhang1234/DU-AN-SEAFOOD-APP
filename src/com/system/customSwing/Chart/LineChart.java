...
import com.system.customSwing.Chart.BlankChart.BlankPlotChart;
import com.system.customSwing.Chart.BlankChart.BlankPlotChatRender;
import com.system.customSwing.Chart.BlankChart.SeriesSize;
...
public class LineChart extends javax.swing.JPanel {
    ...
    public LineChart() {
        ...
        blankPlotChart2.setBlankPlotChatRender(new BlankPlotChatRender() {
            @Override
    ...
    public void addData(ModelChart data) {
        model.add(data);
        blankPlotChart2.setLabelCount(model.size());
        double max = data.getMaxValues();
        if (max > blankPlotChart2.getMaxValues()) {
            blankPlotChart2.setMaxValues(max);
        }
    }
    ...
    public void clear() {
        animate = 0;
        showLabel = null;
        blankPlotChart2.setLabelCount(0);
        model.clear();
        repaint();
    }
    ...
    private void initComponents() {
        ...
        blankPlotChart2 = new com.system.customSwing.Chart.BlankChart.BlankPlotChart();
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(blankPlotChart2, javax.swing.GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE)
                    .addComponent(panelLegend, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(blankPlotChart2, javax.swing.GroupLayout.DEFAULT_SIZE, 245, Short.MAX_VALUE)
    ...
    private com.system.customSwing.Chart.BlankChart.BlankPlotChart blankPlotChart2;
