 ...
 */
package com.system.customSwing.Shadow;
...
public class BorderShadow {
    ...
    private static BorderShadow instance;

    private BorderShadow() {
    }

    public static BorderShadow getInstance() {
        if (instance == null) {
            instance = new BorderShadow();
        }
        return instance;
    }
