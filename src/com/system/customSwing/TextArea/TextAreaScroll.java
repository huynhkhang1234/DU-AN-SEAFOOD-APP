 ...
 */
package com.system.customSwing.TextArea;

import com.system.customSwing.ScrollBar.ScrollBarCustom;
...
public class TextAreaScroll extends JScrollPane {
    ...
    public TextAreaScroll() {
        ...
        setHorizontalScrollBar(new com.system.customSwing.ScrollBar.ScrollBar());
    ...
    private void createHintText(Graphics2D g2) {
        ...
        //Rectangle2D r2 = ft.getStringBounds(null, g2);
        ...
        //g2.drawString(null, in.right, (int) (in.top + textY + ft.getAscent() - size));
    }
