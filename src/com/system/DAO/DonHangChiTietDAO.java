...
public class DonHangChiTietDAO extends DAO<DonHangChiTiet, Object> {
	...
	// select tổng số bàn hiện có
	String selectSumTable = "select count(SoBan) from DonHang";

	@Override
	public void insert(DonHangChiTiet entity) {
		JDBC.update(insertDonHangChiTiet, entity.getMaDonHang(), entity.getMaDoAn(), entity.getMaDoUong(),
				entity.getSoLuong(), entity.getGiaTien(), entity.getThanhTien());
	}

	@Override
	public void update(DonHangChiTiet entity) {
		JDBC.update(insertDonHangChiTiet, entity.getMaDonHang(), entity.getMaDoAn(), entity.getMaDoUong(),
				entity.getSoLuong(), entity.getGiaTien(), entity.getThanhTien(), entity.getSTT());
	}
	...
	public List<DonHangChiTiet> selectAllTable() {
		return this.selectBySql(selectSumTable);
	}
