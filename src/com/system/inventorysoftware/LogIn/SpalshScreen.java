...
import com.system.main.DangNhap;
...
public class SpalshScreen extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SpalshScreen dialog = new SpalshScreen();
    ...
    private void init() {
        ...
        new Timer(10, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int value = loadingprogress.getValue();
                if (value < loadingprogress.getMaximum()) {
                    loadingprogress.setValue(value + 1);
                    loadingnumber.setText(value + 1 + "%");
                } else {
